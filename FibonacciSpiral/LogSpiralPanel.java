...
public class LogSpiralPanel extends JPanel
{
    ...
    private Rectangle goldenRectangle = new Rectangle(10,10,540,540);
    private final int arcAngle = 90;
    ...
    private void recursiveDraw(Graphics g, double x, double y, double side, int angle)
    {
        ...
        int rectx = (int) x;
        int recty = (int) y;
        int rectSide = (int) side;
        
        goldenRectangle = new Rectangle (rectx, recty, rectSide, rectSide);
        ...
        if (side >= 1)
        {
            ...
            if (angle <= 0)
            {
                ...
                x = calculateNewX(x,angle,side,newSide);
                y = calculateNewY(y,angle,side,newSide);
            }
            else if (angle <= 90)
            {
                newSide = side/GOLDEN_MEAN;
            ...
            recursiveDraw(g,x,y,newSide,angle);
        }
